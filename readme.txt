...
KeepConsoleOpen is a class that allows an application to automatically keep the console open after closing.

It is intended to be used with SFML (www.sfml-dev.org) so SFML is required to use this code as is. It can be easily adapted to work without SFML if required.
...
Please note that this code is only designed to aid through the creation and debugging of projects. It allows the console to be viewed after the application has completed its tasks. It is recommended that, when the code released, any use of this code is removed.
